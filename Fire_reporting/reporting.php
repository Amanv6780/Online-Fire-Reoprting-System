...
$query=mysqli_query($con,"insert into tblfirereport(fullName,mobileNumber,location,message) value('$fname','$mno','$location','$message')");
if($query){
...
<?php include_once('includes/header.php') ?>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-12"><img class="img-fluid rounded mb-4 mb-lg-0" src="assets/reporting.png" alt="..."  /></div>
